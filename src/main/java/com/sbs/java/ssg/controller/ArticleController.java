...
public class ArticleController extends Controller {
	...
	public void makeTestData() {
		...
		articleService
				.write(new Article(Container.articleDao.getNewId(), Util.getNowDateStr(), 1, 2, "제목1", "내용1", 10));
		articleService
				.write(new Article(Container.articleDao.getNewId(), Util.getNowDateStr(), 2, 1, "제목2", "내용2", 22));
		articleService
				.write(new Article(Container.articleDao.getNewId(), Util.getNowDateStr(), 2, 1, "제목3", "내용3", 33));
	}
